...
The importance is not what we do, but the [intention](<intention.md>) behind the action, followed by [progressive approach](<progressive approach.md>) to achieve it and the [unattachment](<unattachment.md>)
