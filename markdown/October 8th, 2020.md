...
- Today I still learn that [[focus]] can't happen if we force it to happen. When we start to merge the experiences, things will start to be clear and be condense, so that's the focus happens in a [[natural way of living life]] way. [[soul evolution]] [[union experiences]]
